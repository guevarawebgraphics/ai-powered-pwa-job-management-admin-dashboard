...
var App = function() {
    ...
    var uiInit = function() {
        ...
        // Initialize Tooltips
        $('[data-toggle="tooltip"], .enable-tooltip').tooltip({container: 'body', animation: false, trigger: 'hover'});
        ...
        $('a', colorList).click(function(e){
            ...
            if (themeColor === 'default') {
                ...
                if (themeLink.length) {
                    ...
                    $('link.themes').before('<link id="theme-link" rel="stylesheet" href="' + themeColor + '">');
                    themeLink = $('#theme-link');
                }
            }
