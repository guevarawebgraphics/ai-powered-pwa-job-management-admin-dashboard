        ...
        <div class="form-group{{ $errors->has('otp') ? ' has-error' : '' }}">
            <div class="col-xs-12">
                <div class="input-group">
                    ...
                    <input type="text" id="otp" name="otp" class="form-control input-lg" placeholder="One Time Password" value="{{ old('otp') }}" autofocus>
                </div>
                @if ($errors->has('otp'))
                    <span id="otp-error" class="help-block animation-slideDown">
                    {{ $errors->first('otp') }}
                </span>
                @endif
            </div>
