...
@section('content')
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><span href="javascript:void(0)">Edit Payee</span></li>
    </ul>
    <div class="row">
        {{  Form::open([
            'method' => 'PUT',
            'id' => 'edit-payee',
            'route' => ['admin.payees.update', $payee->payee_id],
        ...
        <div class="col-md-12">
            <div class="block">
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Edit Payee "{{$payee->payee_name}}"</strong></h2>
                </div>
                ...
                <div class="form-group{{ $errors->has('payee_name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="payee_name" name="payee_name"
                               placeholder="Enter Payee First name.." value="{{ old('payee_name') ?? $payee->payee_name }}">
                ...
                <div class="form-group{{ $errors->has('payee_last_name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="payee_last_name" name="payee_last_name"
                               placeholder="Enter Payee Last name.." value="{{ old('payee_last_name') ?? $payee->payee_last_name}}">
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="email" name="email"
                               placeholder="Enter Payee Email.." value="{{ old('email') ?? $payee->email }}">
                        @if($errors->has('email'))
                ...
                <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="phone_number" name="phone_number"
                               placeholder="Enter Payee Phone Number.." value="{{ old('phone_number') ?? $payee->phone_number  }}">
                ...
                <div class="form-group{{ $errors->has('payee_notes') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" id="payee_notes" name="payee_notes">{{ old('payee_notes')  ?? $payee->payee_notes }}</textarea>
                ...
                <div class="form-group{{ $errors->has('payee_relation') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="payee_relation" name="payee_relation"
                               placeholder="Enter Payee Relation.." value="{{ old('payee_relation') ?? $payee->payee_relation }}">
                ...
                {{-- <div class="form-group{{ $errors->has('extra_field1') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="extra_field1" name="extra_field1"
                               placeholder="Enter Extra Field#1.." value="{{ old('extra_field1') ?? $payee->extra_field1  }}">
                ...
                <div class="form-group{{ $errors->has('extra_field2') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="extra_field2" name="extra_field2"
                               placeholder="Enter Extra Field#2.." value="{{ old('extra_field2') ?? $payee->extra_field2  }}">
                ...
                {{-- <div class="form-group{{ $errors->has('banner_image') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-offset-3 col-md-9">
                        <a href="{{ asset($payee->banner_image) }}" class="zoom img-thumbnail" style="cursor: default !important;" data-toggle="lightbox-image">
                            <img src="{{ $payee->banner_image != '' ? asset($payee->banner_image) : '' }}"
                                 alt="{{ $payee->banner_image != '' ? asset($payee->banner_image) : '' }}"
                        ...
                        <a href="javascript:void(0)" class="btn btn-xs btn-danger remove-image-btn"
                           style="display: {{ $payee->banner_image != '' ? '' : 'none' }};"><i class="fa fa-trash"></i> Remove</a>
                ...
                <div class="form-group file-container {{ $errors->has('file') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-offset-3 col-md-9">
                        <a target="_blank" href="{{ asset($payee->file) }}" class="file-anchor">
                            {{ $payee->file }}
                        </a>
                        <br>
                        <a href="javascript:void(0)" class="btn btn-xs btn-danger remove-file-btn"
                           style="display: {{ $payee->file != '' ? '' : 'none' }};"><i class="fa fa-trash"></i> Remove</a>
                    ...
                    <div class="col-md-9">
                        <label class="switch switch-primary">
                            <input type="checkbox" id="is_active" name="is_active"
                                   value="1" {{ Request::old('is_active') ? : ($payee->is_active ? 'checked' : '') }}>
                            <span></span>
                        </label>
                    </div>
                </div>
