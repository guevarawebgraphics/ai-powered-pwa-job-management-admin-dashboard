        ...
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="client_slug" name="slug"
                               placeholder="Enter Client slug.." value="{{ old('slug') }}">
                        @if($errors->has('slug'))
                ...
                <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <textarea id="client_content" name="content" rows="9"
                                  class="form-control ckeditor" placeholder="Enter Client content..">{{ old('content') }}</textarea>
