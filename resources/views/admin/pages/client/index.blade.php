                    ...
                    <tr data-client-id="{{$client->id}}">
                        ...
                        <td class="text-left">
                            @if($client->slug && $client->slug != '')
                                <a target="_blank" href="{{ add_http($client->slug) }}">{{ add_http($client->slug) }}</a>
                            @endif
                        </td>
                        <td class="text-left">{!! str_limit(strip_tags($client->content), 50) !!}</td>
                        <td class="text-center">{{ $client->created_at->format('F d, Y') }}</td>
