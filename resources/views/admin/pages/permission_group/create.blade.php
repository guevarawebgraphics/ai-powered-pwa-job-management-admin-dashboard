...
@section('content')
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><span href="javascript:void(0)">Add New Permission Group</span></li>
    </ul>
    <div class="row">
        {{  Form::open([
            'method' => 'POST',
            'id' => 'create-permission-group',
            'route' => ['admin.permission_groups.store'],
        ...
        <div class="col-md-12">
            <div class="block">
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Add new Permission Group</strong></h2>
                </div>
