        ...
        <div class="col-md-12">
            <div class="block">
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Add new Gig</strong></h2>
                </div>
                    ...
                    <div class="col-md-6">
                        <select class="form-control" id="model_number_main" name="model_number_main">
                            ...
                            @foreach( getMachine() ?? [] as $field )
                                <option value="{{$field->model_number}}">{{$field->model_number}} {{$field->brand_name}} {{$field->machine_type}} </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group{{ $errors->has('initial_issue') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" id="initial_issue" name="initial_issue" placeholder="The machine is overheating after prolonged use."></textarea>
                ...
                {{-- <div class="form-group{{ $errors->has('gig_price') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="gig_price" name="gig_price" value="{{ old('gig_price') }}" placeholder="0.00">
                ...
                <div class="form-group{{ $errors->has('start_time') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="time" class="form-control" id="start_time" name="start_time"
                               placeholder="Enter Start Time.." value="{{ old('start_time') }}">
                    ...
                    <div class="col-md-9">
                        <select class="form-control" id="assigned_tech_id" name="assigned_tech_id">
                            ...
                            @foreach( getCustomers() ?? [] as $field )
                                <option value="{{$field->id}}">{{$field->name}} ({{$field->email}})</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group{{ $errors->has('gig_price') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        ...
                        <select class="form-control" id="gig_price" name="gig_price">   
                            @foreach( getPrices() ?? [] as $array )
                                <option value="{{$array['name']}}"
                                    {{  Request::old('gig_price') && Request::old('gig_price') == $array['name'] ? 'selected' : '' }}
                                >{{$array['name']}} 
                                    @if($array['name'] != "Other")
                                        (${{$array['amount']}})
                                    @endif
                        ...
                        <input type="number" class="form-control mt-2 decimal" id="custom_gig_price" name="custom_gig_price"
                            ...
                            style="{{ Request::old('gig_price') && Request::old('gig_price') == "Other" ? 'display:block;' : 'display:none;' }}">
                ...
                <div class="form-group{{ $errors->has('repair_notes') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" id="repair_notes" name="repair_notes" placeholder="The machine is overheating after prolonged use."></textarea>
                ...
                {{-- <div class="form-group{{ $errors->has('trainee_included') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" id="trainee_included" name="trainee_included"></textarea>
                        @if($errors->has('trainee_included'))
                            <span class="help-block animation-slideDown">{{ $errors->first('trainee_included') }}</span>
                        @endif
                    </div>
                ...
                {{-- <div class="form-group{{ $errors->has('youtube_link') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="youtube_link" name="youtube_link"
                               placeholder="Enter Youtube Link.." value="{{ old('youtube_link') }}">
                ...
                {{-- <div class="form-group{{ $errors->has('qb_invoice_number') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="qb_invoice_number" name="qb_invoice_number"
                               placeholder="Enter Invoice Number.." value="{{ old('qb_invoice_number') }}">
...
@push('extrascripts')
 ...
 <script>
    $(document).ready(function () {
        ...
        let traineeIncluded = @json(''); // Get stored IDs
        ...
        console.log(selectedTraineesID);
...
function checkTechAvailability(techID, selectedDate, selectedTime) {
    $.ajax({
        ...
        success: function (response) {
            ...
            console.log(`techID: ${techID} - from: ${from} to: ${to}`);
